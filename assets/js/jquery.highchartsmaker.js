...
(function($){
    ...
    function isValidDate(date){
        if(new Date(date) == 'Invalid Date') {
            ...
            var y = matches[1];
            var composedDate = new Date.UTC(y);
            return composedDate.getFullYear() == y;
        }
        return true;
    };
    ...
    function getValidDate(date) {
        if(isValidDate(date)) {
            ...
            if(composedDate == 'Invalid Date') {
                ...
                return Date.UTC(composedDate.getFullYear());
            }
            return composedDate;
        }
        return false;
    ...
    $.fn.highchartsMaker = function(datatable, options){
        ...
        return this.each(function(){
            ...
            if(iterator == 'date' && date_interval == 31557500000) {
                var i = 0;
                do {
                    ...
                    i++;
                }while(date_interval == 31557600000);
            }
            ...
            // chart_options.credits.text='Fecha de creación: ' + now.toString("mmmm dS, yyyy, h:MM:ss TT");
            ...
            chart_options.yAxis.title.text = group_by ? columns[2] : 'Consumo KwH';
            ...
            if(iterator == 'label') {
                ...
                chart_options.tooltip = {
                    formatter: function () {
                        return '<b>'+Highcharts.dateFormat('', this.x)+'</b><br /><b style="color:'+this.series.color+';">'+this.series.name+'</b>: '+numberWithCommas(this.y);
                    }
                };
            }
