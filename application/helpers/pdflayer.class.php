...
class pdflayer{
    ...
    private $access_key = '1bc57053fcd81a4a146e83f40250aaa2';
    ...
    */
    public function convert($redirect=false){
        ...
        if( !empty($this->params['footer_html']) ){
            ...
            $postData['footer_html'] = $this->params['footer_html'];
    ...
    */
    public function build_request(){
        ...
        foreach( $this->params as $key=>$value ){
            ...
            }elseif( $key == 'document_html' || $key == 'header_html' || $key == 'footer_html' ){
                //this will be posted
