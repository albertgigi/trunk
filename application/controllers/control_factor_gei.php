...
function index()
{
	$data['title'] = '<i class="icon-fire"></i>';
	$data['body'] = 'inicio_factor_gei';
...
/* Realiza la creación de un nuevo recibo, debe actuar como refresh de la pagina en ambos casos, solo que repetir_gei agrega los datos a la tabla correspondiente */
function creargeirepeat()	
{
	$this->modelo_factor_gei->creargeirepeat();
	$submit = $this->input->post('enviar');
...
/***********************************************************************************************
CONTROL PARA GRAFICAS GEI DE MESES POR AÑOS (REQUERIMIENTO DE IMPOSICION)
***********************************************************************************************/
...
/***********************************************************************************************
CONTROL PARA GRAFICAS GEI DE MESES POR AÑOS - RE EDICIÓN: RANGO MENOR DE AÑOS (REQUERIMIENTO DE IMPOSICION)
***********************************************************************************************/
...
function kwcperiodo_elec_gm_5yrs()
{
	...
	$data['tittle'] = '<i class="icon-bolt"></i> Energía Eléctrica';
	$data['subtitle'] = 'Electricidad 2011 -  ' .date('Y', strtotime('-1 year')).  ' GM 5 AÑOS';
	$data['body'] = 'kwcapitayear_elec_gm_5yrs_pdf.html';
	$this->load->view('main', $data);
}
/********************************************************CIERRE*******************************************************/
...
function kgcperiodo_elec_gm_5yrs()
{
	...
	$data['subtitle'] = 'Electricidad ' .date('Y', strtotime('-5 year')).  ' -  ' .date('Y', strtotime('-1 year')).  ' GM INTERVALO 5 AÑOS';
...
function metrica_gei_elec_gm_5yrs()
{
	...
	else
	{
		...
		$data['tittle'] = '<i class="icon-bolt"></i> Energía Eléctrica';
		$data['subtitle'] = 'Consumo de Electricidad ' .date('Y', strtotime('-5 year')).  ' -  ' .date('Y', strtotime('-1 year')).  ' GM INTERVALO 5 AÑOS';
...
function metrica_gei_gas_gm_5yrs()
{
	...
	else
	{
		...
		$data['title'] = '<i class="icon-fire"></i> Gas Natural';
		$data['subtitle'] = 'Consumo de Gas ' .date('Y', strtotime('-5 year')).  ' -  ' .date('Y', strtotime('-1 year')).  ' GM INTERVALO 5 AÑOS';
...
function consumoelecxcampusGM5yrs()
{
			...
			if(!!empty($campus_gmtfinal))
	{
		...
		$data['title']= '<i class="icon-bolt"></i> Energía Eléctrica';
		$data['subtitle'] = 'Consumo de Electricidad x Campus ' .date('Y', strtotime('-5 year')).  ' -  ' .date('Y', strtotime('-1 year')).  ' GM INTERVALO 5 AÑOS';
...
function consumoaguaxcampusGM5yrs()
{
			...
			if(!!empty($campus_gmtfinal))
	{
		...
		$data['title']= '<i class="icon-tint"></i> Agua';
		$data['subtitle'] = 'Consumo de Agua x Campus ' .date('Y', strtotime('-5 year')).  ' -  ' .date('Y', strtotime('-1 year')).  ' GM INTERVALO 5 AÑOS';
...
function consumogaasxcampusGM5yrs()
{
			...
			if(!!empty($campus_gmtfinal))
	{
		...
		$data['title']= '<i class="icon-fire"></i> Gas Natural';
		$data['subtitle'] = 'Consumo de Gas x Campus ' .date('Y', strtotime('-5 year')).  ' -  ' .date('Y', strtotime('-1 year')).  ' GM INTERVALO 5 AÑOS';
...
/********************************************************CIERRE*******************************************************/
/***************************************************************************************************************************/
						/*INICIO PARA EL CONTROL DE LA BUSQUEDA DE CONSUMO X DEPENDENCIAS (ING. FELIX)*/
/***************************************************************************************************************************/
...
/***************************************************************************************************************************/
//Genera el formulario para la consulta de Consumo por Dependencias año pasado y actual para ELECTRICIDAD//



function conteleccomparacion2()
{
	$submit = $this->input->post('enviar');
	...
	if($submit=='descargarpdfelec')
	{
		$this->modelo_factor_gei->descargarpdfelec();
	}
	else
	{
		// Carga combobox campus
		...
		$data['catdepesdep']	= $this->modelo_factor_gei->catdepesxragraficoanioactualdep();
		$data['catdepescta']	= $this->modelo_factor_gei->catdepesxragraficoanioactualcta();

		// Genera las consultas por dependencias
		$data['resultdependencia'] = $this->modelo_factor_gei->graficaelecdepeyear();
		$data['resultdependenciadep'] = $this->modelo_factor_gei->graficaelecdepeyeardep();
		$data['resultdependenciacta'] = $this->modelo_factor_gei->graficaelecdepeyearcta();

		$data['depe_eleanio_actual'] = $depe_eleanio_actual;
		$data['cta_eleanio_actual'] = $cta_eleanio_actual;
		/*$data['consumo_mes_anterior'] = $consumo_mes_anterior;
		$data['consumo_mismo_mes_year_anterior'] = $consumo_mismo_mes_year_anterior;*/

		if(!empty($cta_eleanio_actual))
		{
			$data['Eneroelecactualyearcta'] = $this->modelo_factor_gei->Eneroelecactualyearcta($cta_eleanio_actual);
			$data['Febreroelecactualyearcta'] = $this->modelo_factor_gei->Febreroelecactualyearcta($cta_eleanio_actual);
			$data['Marzoelecactualyearcta'] = $this->modelo_factor_gei->Marzoelecactualyearcta($cta_eleanio_actual);
			$data['Abrilelecactualyearcta'] = $this->modelo_factor_gei->Abrilelecactualyearcta($cta_eleanio_actual);
			$data['Mayoelecactualyearcta'] = $this->modelo_factor_gei->Mayoelecactualyearcta($cta_eleanio_actual);
			$data['Junioelecactualyearcta'] = $this->modelo_factor_gei->Junioelecactualyearcta($cta_eleanio_actual);
			$data['Julioelecactualyearcta'] = $this->modelo_factor_gei->Julioelecactualyearcta($cta_eleanio_actual);
			$data['Agostoelecactualyearcta'] = $this->modelo_factor_gei->Agostoelecactualyearcta($cta_eleanio_actual);
			$data['Septiembreelecactualyearcta'] = $this->modelo_factor_gei->Septiembreelecactualyearcta($cta_eleanio_actual);
			$data['Octubreelecactualyearcta'] = $this->modelo_factor_gei->Octubreelecactualyearcta($cta_eleanio_actual);
			$data['Noviembreelecactualyearcta'] = $this->modelo_factor_gei->Noviembreelecactualyearcta($cta_eleanio_actual);
			$data['Diciembreelecactualyearcta'] = $this->modelo_factor_gei->Diciembreelecactualyearcta($cta_eleanio_actual);
		}	
		else{
			if(!!empty($cta_eleanio_actual))
		{
		...
		if(!!empty($depe_eleanio_actual))
	{
		...
		$data['body'] = 'consultaconcoselecxdepebup2';
		$this->load->view('main', $data);
}
...
function conteleccomparacion()
{
	...
	if($submit=='volver')
		...
		{
			$data['recibos']	= $this->modelo_factor_gei->conteleccomparacionv2();
			$data['servicios']	= $this->modelo_factor_gei->sercatgrafdepeselec();
			//$data['obtenmes']	= $this->modelo_factor_gei->obtenumeroames();
			//$data['mocos'] = $this->modelo_factor_gei->debug_to_console();
			$this->console_log($year);
			$data['dependencia']= $dependencia;
			$data['year'] = $year;
					...
					$data['title'] = '<i class="icon-bolt"></i> Energía Eléctrica';
					$data['subtitle'] = 'Gráfica Anual de Costos de Electricidad';
					$data['body'] = 'consultaconcoselecxdepe';
					$this->load->view('main', $data);
		}
}
...
//Genera el formulario para la consulta de Consumo por Dependencias año pasado y actual para AGUA//



function contaguacomparacion()
{
	$submit = $this->input->post('enviar');
	...
	if($submit=='reloadtablasaguacomparacion')
	{
		$this->modelo_factor_gei->creatablascomparacionagua();
		$this->modelo_factor_gei->droprtablascompaguaactualypasado();
		$this->modelo_factor_gei->creatablascomparacionagua();
		redirect("control_factor_gei/contaguacomparacion");
	}
	if($submit=='descargarpdfagua')
	{
		$this->modelo_factor_gei->descargarpdfagua();
	}
	else
	{
		// Carga combobox campus

		$data['catdepes']	= $this->modelo_factor_gei->catdepesxragraficoanioactualagua();

		// Genera las consultas por dependencias
		$data['resultdependencia'] = $this->modelo_factor_gei->graficaaguadepeyear();

		$data['depe_aguaanio_actual'] = $depe_aguaanio_actual;
		/*$data['consumo_mes_anterior'] = $consumo_mes_anterior;
		$data['consumo_mismo_mes_year_anterior'] = $consumo_mismo_mes_year_anterior;*/
	...
	{
		$data['Eneroaguaactualyear'] = $this->modelo_factor_gei->Eneroaguaactualyear($depe_aguaanio_actual);
		$data['Febreroaguaactualyear'] = $this->modelo_factor_gei->Febreroaguaactualyear($depe_aguaanio_actual);
		$data['Marzoaguaactualyear'] = $this->modelo_factor_gei->Marzoaguaactualyear($depe_aguaanio_actual);
		$data['Abrilaguaactualyear'] = $this->modelo_factor_gei->Abrilaguaactualyear($depe_aguaanio_actual);
		$data['Mayoaguaactualyear'] = $this->modelo_factor_gei->Mayoaguaactualyear($depe_aguaanio_actual);
		$data['Junioaguaactualyear'] = $this->modelo_factor_gei->Junioaguaactualyear($depe_aguaanio_actual);
		$data['Julioaguaactualyear'] = $this->modelo_factor_gei->Julioaguaactualyear($depe_aguaanio_actual);
		$data['Agostoaguaactualyear'] = $this->modelo_factor_gei->Agostoaguaactualyear($depe_aguaanio_actual);
		$data['Septiembreaguaactualyear'] = $this->modelo_factor_gei->Septiembreaguaactualyear($depe_aguaanio_actual);
		$data['Octubreaguaactualyear'] = $this->modelo_factor_gei->Octubreaguaactualyear($depe_aguaanio_actual);
		$data['Noviembreaguaactualyear'] = $this->modelo_factor_gei->Noviembreaguaactualyear($depe_aguaanio_actual);
		$data['Diciembreaguaactualyear'] = $this->modelo_factor_gei->Diciembreaguaactualyear($depe_aguaanio_actual);
	}	
	else{
		if(!!empty($depe_aguaanio_actual))
	{
		...
		$data['title']= '<i class="icon-oil"></i> AGUA';
		$data['subtitle'] = 'Comparativo de consumos x Dependencia ' .date('Y', strtotime('-1 year')).  ' -  ' .date('Y', strtotime('0 year')).  '';
		$data['body'] = 'consultaconcosaguaxdepe';
		$this->load->view('main', $data);
}
...
//Genera el formulario para la consulta de Consumo por Dependencias año pasado y actual para GAS//



function contgascomparacion()
{
	$submit = $this->input->post('enviar');
	...
	if($submit=='reloadtablasgascomparacion')
	{
		$this->modelo_factor_gei->creatablascomparaciongas();
		$this->modelo_factor_gei->droprtablascompgasactualypasado();
		$this->modelo_factor_gei->creatablascomparaciongas();
		redirect("control_factor_gei/contgascomparacion");
	}
	if($submit=='descargarpdfgas')
	{
		$this->modelo_factor_gei->descargarpdfgas();
	}
	else
	{
		// Carga combobox campus

		$data['catdepes']	= $this->modelo_factor_gei->catdepesxragraficoanioactualgas();

		// Genera las consultas por dependencias
		$data['resultdependencia'] = $this->modelo_factor_gei->graficagasdepeyear();

		$data['depe_gasanio_actual'] = $depe_gasanio_actual;
		/*$data['consumo_mes_anterior'] = $consumo_mes_anterior;
		$data['consumo_mismo_mes_year_anterior'] = $consumo_mismo_mes_year_anterior;*/
	...
	{
		$data['Enerogasactualyear'] = $this->modelo_factor_gei->Enerogasactualyear($depe_gasanio_actual);
		$data['Febrerogasactualyear'] = $this->modelo_factor_gei->Febrerogasactualyear($depe_gasanio_actual);
		$data['Marzogasactualyear'] = $this->modelo_factor_gei->Marzogasactualyear($depe_gasanio_actual);
		$data['Abrilgasactualyear'] = $this->modelo_factor_gei->Abrilgasactualyear($depe_gasanio_actual);
		$data['Mayogasactualyear'] = $this->modelo_factor_gei->Mayogasactualyear($depe_gasanio_actual);
		$data['Juniogasactualyear'] = $this->modelo_factor_gei->Juniogasactualyear($depe_gasanio_actual);
		$data['Juliogasactualyear'] = $this->modelo_factor_gei->Juliogasactualyear($depe_gasanio_actual);
		$data['Agostogasactualyear'] = $this->modelo_factor_gei->Agostogasactualyear($depe_gasanio_actual);
		$data['Septiembregasactualyear'] = $this->modelo_factor_gei->Septiembregasactualyear($depe_gasanio_actual);
		$data['Octubregasactualyear'] = $this->modelo_factor_gei->Octubregasactualyear($depe_gasanio_actual);
		$data['Noviembregasactualyear'] = $this->modelo_factor_gei->Noviembregasactualyear($depe_gasanio_actual);
		$data['Diciembregasactualyear'] = $this->modelo_factor_gei->Diciembregasactualyear($depe_gasanio_actual);
	}	
	else{
		if(!!empty($depe_gasanio_actual))
	{
		...
		$data['title']= '<i class="icon-bolt"></i> gastricidad';
		$data['subtitle'] = 'Comparativo de consumos x Dependencia ' .date('Y', strtotime('-1 year')).  ' -  ' .date('Y', strtotime('0 year')).  '';
		$data['body'] = 'consultaconcosgasxdepe';
		$this->load->view('main', $data);
}
