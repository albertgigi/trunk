...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Kilogramos Per Cápita por Año'
        },
        ...
        series: [{
            ...
            color: "#53868b", //Se define el color de la columna
            data: [
            <?php
            $sql = "SELECT `wtrkgcapitayear` AS WKGCYEAR FROM pdc_factor_gei_all";
            $result1 = mysqli_query($connection,$sql);
            while ($registros1 = mysqli_fetch_array($result1))
            {
            ?>
                <?php echo $registros1["WKGCYEAR"] ?>,
                <?php
            }
            ?>
            ],
