...
$(function () {
    $('#container').highcharts({
        ...
        series: [{
            ...
            data: [
            <?php
            $sql = "SELECT FORMAT((`rawm3gasxgei` / 1000000), 4) AS RGASGEI FROM pdc_factor_gei_all";
            $result1 = mysqli_query($connection,$sql);
            while ($registros1 = mysqli_fetch_array($result1))
            {
            ?>
                <?php echo $registros1["RGASGEI"] ?>,
                <?php
            }
            ?>
            ...
            data: [
            <?php
            $sql = "SELECT cantidad_alumnos AS CALGAS FROM pdc_factor_gei_all";
            $result3 = mysqli_query($connection,$sql);
            while ($registros3 = mysqli_fetch_array($result3))
            {
            ?>
                <?php echo $registros3["CALGAS"] ?>,
                <?php
            }
            ?>
            ...
            name: 'Consumo Anual de Gas(m3) - Miles',
            color: '#eeee00', //Se define el Color eeee00
            data: [
            <?php
            $sql = "SELECT rawm3gas AS RGAS FROM pdc_factor_gei_all";
