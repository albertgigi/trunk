...
$(function () {
    ...
    title: {
        text: 'Consumo Total de Metros Cúbicos de Agua Potable y Agua Residual Tratada'
    },
	subtitle:{
		text: 'SOLO CD. UNIVERSITARIA'
	},
    xAxis: {
        categories: [
        <?php
