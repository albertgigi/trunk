...
require_once('ReporteSQL2PDF.class.php');

//make sure the DB connection is ok
mysqli_connect('localhost','root','');
mysqli_select_db('panel');
...
$obj->setHtmlUrl("http://panelitodc.me:8080/PanelControlDTI/trunk/application/views/vistareporte.html");
...
//pdf version
$pdfVersion = '1.5'; //change it according to your need
/*
