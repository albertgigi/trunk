...
$(function () {
    $('#container').highcharts({
        ...
        series: [{
            ...
            data: [
            <?php
            $sql = "SELECT `cantidad_alumnos` AS CALWTR FROM pdc_factor_gei_all";
            $result3 = mysqli_query($connection,$sql);
            while ($registros3 = mysqli_fetch_array($result3))
            {
            ?>
                <?php echo $registros3["CALWTR"] ?>,
                <?php
            }
            ?>
        ...
        },
{
            ...
            data: [
            <?php
            $sql = "SELECT `rawm3wtrxgei` AS RWTRGEI FROM pdc_factor_gei_all";
            $result1 = mysqli_query($connection,$sql);
            while ($registros1 = mysqli_fetch_array($result1))
            {
            ?>
                <?php echo $registros1["RWTRGEI"] ?>,
                <?php
            }
            ?>
        ...
        },
        {
            ...
            data: [
            <?php
            $sql = "SELECT `rawm3wtr` AS RWTR FROM pdc_factor_gei_all";
            $result2 = mysqli_query($connection,$sql);
            while ($registros2 = mysqli_fetch_array($result2))
            {
            ?>
                <?php echo $registros2["RWTR"] ?>,
                <?php
            }
            ?>
