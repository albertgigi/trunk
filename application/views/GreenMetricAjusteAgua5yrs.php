   ...
   <div id = "sliders">
      ...
      <script language = "JavaScript">
         $(document).ready(function() {
            ...
            var title = {
               text: 'AGUA <?php echo $item->campus_gmtfinal?>'
            };
...
<table id="mugres" class="table table-condensed table-bordered table-hover">
      ...
      <?php if($resecexcgm5yrs): ?>
         ...
         <tr class="active">
            <td><b>Total</b></td>
            <td class="text-right"><b><?php echo number_format($Eneroaguaxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Febreroaguaxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Marzoaguaxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Abrilaguaxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Mayoaguaxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Junioaguaxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Julioaguaxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Agostoaguaxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Septiembreaguaxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Octubreaguaxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Noviembreaguaxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Diciembreaguaxcampustot5yrs);?></b></td>
         </tr>
      <?php else: ?>
         <tr>
            <td colspan=10>Favor de seleccionar el campus a consultar.</td>
