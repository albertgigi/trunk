...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Kilogramos de CO2 Per Cápita por Año (GM)'
        },
        ...
        series: [{
            ...
            name: 'Kilogramos de CO2 Per Cápita Anual',
            //color: "#a2cd5a", //Se define el color de la columna
            color: "#87ceeb", //Se define el color de la columna Celeste
            data: [
            <?php
            $sql = "SELECT FORMAT((v2gmwtrkgcapitayear), 2) AS KGWXCY FROM gmpdcfactorgeiallv2";
            //$sql = "SELECT FORMAT((wtrkgcapitayear), 2) AS KGWXCY FROM pdc_factor_gei_all";
            $result1 = mysqli_query($connection,$sql);
            while ($registros1 = mysqli_fetch_array($result1))
            {
            ?>
                <?php echo $registros1["KGWXCY"] ?>,
                <?php
            }
            ?>
            ],
