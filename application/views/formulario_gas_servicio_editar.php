<?php echo form_open("consumo_gas/servicio_editar/$servicio->id"); ?>
...
<div class="row">
	...
	<div class="col-md-6">
		...
		<!--<a href="/PanelControlDTI/index.php/consumo_gas/catalogo_dependencias/">Editar Dependencias</a>-->
		<a href="/index.php/consumo_gas/catalogo_dependencias/">Editar Dependencias</a>
	</div>
</div>
