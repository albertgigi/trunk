...
$(function () {
    $('#container').highcharts({
        ...
        series: [{
            ...
            data: [
            <?php
            $sql = "SELECT FORMAT((`gmrawkwxgei5yrs` / 1000000), 2) AS RKWGEI FROM 5yrs_gmpdc_factor_gei_all";
          ...
          style: {
            ...
            data: [
            <?php
            $sql = "SELECT FORMAT((`gmrawkw5yrs` / 1000000), 2) AS RKW FROM 5yrs_gmpdc_factor_gei_all";
            ...
            data: [
            <?php
            $sql = "SELECT FORMAT((`gmcantidad_alumnos5yrs` / 1000), 1) AS CALUMNI FROM 5yrs_gmpdc_factor_gei_all";
...
<div class="table-responsive">
  <table class="table table-bordered table-hover">
    ...
    <tbody>
    <?php if($loadgei5yrs): ?>
      <?php foreach($loadgei5yrs as $item): ?>
      <tr>
        <td><?php echo $item->gmtheyear5yrs; ?></td>
        <td><?php echo number_format($item->gmkwcapitayear5yrs,2); ?></td> <!--Sirve para dar formato y así manipular la información como el usuario requiera.-->
        <td><?php echo number_format($item->gmkgcapitayear5yrs,2); ?> kg</td>
