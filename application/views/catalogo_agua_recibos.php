	...
	<table class="table table-bordered table-hover">
		...
		<?php if($recibos): ?>
			...
			<tr>
				...
				<?php
					echo anchor('consumo_agua/actualizar/'.$item->id, '<span class="icon-edit"></span> Actualizar'); ?><br>
				<?php
			...
			<tr class="active">
				...
				<td></td>
				<td></td>
				<!--<td class="text-right"><b>?php echo $sumaM3;?> m3</b></td>ORIGINAL-->
				<td class="text-right"><b><?php echo number_format($sumaM3);?> m3</b></td>
				<!--<td class="text-right"><b>?php echo "$ ".$sumaCostoAgua;?></b></td>-->
				<td class="text-right"><b><?php echo "$ ".number_format($sumaCostoAgua,2);?></b></td>
				<td></td>
			</tr>
		<?php else: ?>
			<tr>
