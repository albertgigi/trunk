<?php echo form_open("consumo_agua/servicio_buscar"); ?>
<div>
<div class="buscador">
	<div>
		<label>NIS</label>
	...
	<table class="table table-bordered table-hover">
		...
		<?php if($busqueda): ?>
			<tr>
				...
				<td><small>
				<?php echo anchor('consumo_agua/servicio_actualizar/'.$busqueda->id, '<span class="icon-edit"></span> Actualizar'); ?>
				<?php echo anchor('consumo_agua/servicio_borrar/'.$busqueda->id, '<span class="icon-trash"></span> Borrar', 'class="delete"'); ?>
				</small></td>
			</tr>
		<?php else: ?>
			<tr>
