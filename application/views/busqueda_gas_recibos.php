		...
		<?php if($recibos): ?>
			...
			<tr>
				...
				<!--ACTUALIZACION DEL 23-MARZO-2018-->
					<?php
                                if($_SESSION['sess']['level'] == 2){ echo anchor('consumo_gas/recibo/'.$item->id, '<span class="icon-eye-open"></span> Ver', 'class="view" data-remodal-target="modal_ver"'); } ?><br>
					<?php
                                if($_SESSION['sess']['level'] == 1){ echo anchor('consumo_gas/actualizar/'.$item->id, '<span class="icon-edit"></span> Actualizar'); } ?><br>
					<?php
                                if($_SESSION['sess']['level'] == 1){  echo anchor('consumo_gas/borrar/'.$item->id, '<span class="icon-trash"></span> Borrar', 'class="delete"'); } ?>
				<!--ACTUALIZACION DEL 23-MARZO-2018-->
				</td>
			</tr>
			<?php endforeach; ?>
			<tr class="active">
				...
				<td></td>
				<td></td>
				<!--<td class="text-right"><b>?php echo $totalM3Gas;?> m3</b></td>ORIGINAL-->
				<td class="text-right"><b><?php echo number_format($totalM3Gas);?> m3</b></td>
				<!--<td class="text-right"><b>?php echo "$ ".$totalCostoGas;?></b></td>ORIGINAL-->
				<td class="text-right"><b><?php echo "$ ".number_format($totalCostoGas,2);?></b></td>
				<td></td>
			</tr>
		<?php else: ?>
			<tr>
