...
<table id="mugres" class="table table-condensed table-bordered table-hover">
      ...
      <?php if($resecexcnongm): ?>
         ...
         <tr class="active">
            <td><b>Total</b></td>
            <td class="text-right"><b><?php echo number_format($EneroelecxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($FebreroelecxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($MarzoelecxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($AbrilelecxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($MayoelecxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($JunioelecxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($JulioelecxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($AgostoelecxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($SeptiembreelecxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($OctubreelecxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($NoviembreelecxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($DiciembreelecxcampustotnonGM);?></b></td>
         </tr>
      <?php else: ?>
         <tr>
            <td colspan=10>Favor de seleccionar el campus a consultar.</td>
