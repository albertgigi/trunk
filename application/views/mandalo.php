...
<?php echo form_open("consumo_electricidad/crear2/"); ?>

<form action="control_correo.php" name="send" method="post">
    <label>Correo: </correo>
    ...
    <br>
    <label>Datos del recibo:</label>
    <textarea name="datos"></textarea>
    <br><br>
    <button>Entregar</entregar>
</form>
