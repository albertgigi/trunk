<?php echo form_open("consumo_electricidad/servicio_buscar"); ?>	<!--?php echo form_open(); ?--> <!--ORIGNAL?-->
<div>
<div class="buscador">
	<div>
	...
	<table class="table table-bordered table-hover">
		...
		<?php if($busqueda): ?>
			<tr>
				...
				<?php echo anchor('consumo_electricidad/servicio_actualizar/'.$busqueda->id, '<span class="icon-edit"></span> Actualizar'); ?>
				<?php echo anchor('consumo_electricidad/servicio_borrar/'.$busqueda->id, '<span class="icon-trash"></span> Borrar', 'class="delete"');?>
				</small></td>
			</tr>
		<?php else: ?>
			<tr>
