    ...
    <head>
        ...
        <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script>
            ...
            function PrintDiv() {    
               ...
               var popupWin = window.open('', '_blank', 'width=750,height=900'); //AQUI SE DECIDE EL ANCHO Y ALTO DE VISTA PREVIA
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Metros Cúbicos Per Cápita por Año'
        },
        ...
        series: [{
            ...
            color: "#7ac5cd", //Se define el color de la columna
            data: [
            <?php
            $sql = "SELECT FORMAT((m3wtrcapitayear), 2) AS M3XCY FROM pdc_factor_gei_all";
            $result1 = mysqli_query($connection,$sql);
            while ($registros1 = mysqli_fetch_array($result1))
            {
            ?>
                <?php echo $registros1["M3XCY"] ?>,
                <?php
            }
            ?>
            ],
