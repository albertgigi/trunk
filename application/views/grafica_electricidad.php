...
<fieldset>
	<legend>Consumo eléctrico</legend>
	<?php echo form_open("consumo_electricidad/diagnostico"); ?>
	<!--fieldset-->
	<p>Seleccione los parámetros para la gráfica</p>
	...
	<p>
		...
		<select name="measure">
			<option value="consumo" <?php if(isset($measure) && $measure=='consumo'):?> selected <?php endif;?> >kWh</option>
			<option value="factor" <?php if(isset($measure) && $measure=='factor'):?> selected <?php endif;?> >Factor de potencia</option>
