...
<div class="buscador">
	...
	<select
			id="dep_agua_final_x_mepo"
			name="dep_agua_final_x_mepo"
			class="form-control"
		>
			<option value="">----</option>
		<?php foreach($catdepwtfinal as $item): ?>
			<option value="<?php echo $item->dep_agua_final_x_mepo; ?>">
				<?php echo $item->cta_agua_final_x_mepo. " - ".$item->dep_agua_final_x_mepo; ?>
				</option>
			><?php echo $item->dep_agua_final_x_mepo; ?></option>
		<?php endforeach; ?>
		</select>
</div>
...
<div>
		<h3>
	<?php if($resdepwtfinal1): ?>
		<?php foreach($resdepwtfinal1 as $item): ?>
			<tr>
				<td><?php echo $item->dep_agua_final_x_mepo;
				break; ?>
...
<table id="datatables" class="table table-condensed table-bordered table-hover" style="display: none;">
		...
		<tbody>
			<?php if($resdepwtfinal1): ?>
				<?php foreach($resdepwtfinal1 as $item): ?>
			<tr>
				<td><?php echo $item->yer_agua_final_x_mepo; ?></td>
...
<table id="" class="table table-condensed table-bordered table-hover">
		...
		<?php if($resdepwtfinal1): ?>
			...
			<tr class="active">
				<td><b>Total</b></td>
				<td class="text-right"><b><?php echo number_format($EneroTotalWT);?></b></td>
				<td class="text-right"><b><?php echo number_format($FebreroTotalWT);?></b></td>
				<td class="text-right"><b><?php echo number_format($MarzoTotalWT);?></b></td>
				<td class="text-right"><b><?php echo number_format($AbrilTotalWT);?></b></td>
				<td class="text-right"><b><?php echo number_format($MayoTotalWT);?></b></td>
				<td class="text-right"><b><?php echo number_format($JunioTotalWT);?></b></td>
				<td class="text-right"><b><?php echo number_format($JulioTotalWT);?></b></td>
				<td class="text-right"><b><?php echo number_format($AgostoTotalWT);?></b></td>
				<td class="text-right"><b><?php echo number_format($SeptiembreTotalWT);?></b></td>
				<td class="text-right"><b><?php echo number_format($OctubreTotalWT);?></b></td>
				<td class="text-right"><b><?php echo number_format($NoviembreTotalWT);?></b></td>
				<td class="text-right"><b><?php echo number_format($DiciembreTotalWT);?></b></td>
			</tr>
		<?php else: ?>
			<tr>
				<td colspan=10>Favor de seleccionar la dependencia a consultar.</td>
