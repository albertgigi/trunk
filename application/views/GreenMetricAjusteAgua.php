...
<table id="mugres" class="table table-condensed table-bordered table-hover">
      ...
      <?php if($resecexcgmv2): ?>
         ...
         <tr class="active">
            <td><b>Total</b></td>
            <td class="text-right"><b><?php echo number_format($Eneroaguaxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Febreroaguaxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Marzoaguaxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Abrilaguaxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Mayoaguaxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Junioaguaxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Julioaguaxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Agostoaguaxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Septiembreaguaxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Octubreaguaxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Noviembreaguaxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Diciembreaguaxcampustotv2);?></b></td>
         </tr>
      <?php else: ?>
         <tr>
            <td colspan=10>Favor de seleccionar el campus a consultar.</td>
