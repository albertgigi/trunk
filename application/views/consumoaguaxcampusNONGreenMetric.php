...
<table id="mugres" class="table table-condensed table-bordered table-hover">
      ...
      <?php if($resecexcnongm): ?>
         ...
         <tr class="active">
            <td><b>Total</b></td>
            <td class="text-right"><b><?php echo number_format($EneroaguaxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($FebreroaguaxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($MarzoaguaxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($AbrilaguaxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($MayoaguaxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($JunioaguaxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($JulioaguaxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($AgostoaguaxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($SeptiembreaguaxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($OctubreaguaxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($NoviembreaguaxcampustotnonGM);?></b></td>
            <td class="text-right"><b><?php echo number_format($DiciembreaguaxcampustotnonGM);?></b></td>
         </tr>
      <?php else: ?>
         <tr>
            <td colspan=10>Favor de seleccionar el campus a consultar.</td>
