	...
	<table class="table table-bordered table-hover">
		...
		<?php if($servicios): ?>
			...
			<tr>
				...
				<td><small>
				<?php echo anchor('consumo_gas/servicio_actualizar/'.$item->id, '<span class="icon-edit"></span> Actualizar'); ?>
				<?php echo anchor('consumo_gas/servicio_borrar/'.$item->id, '<span class="icon-trash"></span> Borrar', 'class="delete"'); ?>
				</small></td>
			</tr>
			<?php endforeach; ?>
		<?php else: ?>
