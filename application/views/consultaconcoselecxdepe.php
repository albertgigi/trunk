...
<div class="buscador">
   ...
   <option value="">----</option>
      <?php foreach($catdepes as $item): ?>
         <option value="<?php echo $item->depe_eleanio_actual; ?>"
         <?php if($depe_eleanio_actual) echo ($item->depe_eleanio_actual==$depe_eleanio_actual)? 'selected' : ''; ?>>
...
<script>
   ...
   $(document).ready(function () {
    ...
    $(".form-control").on('mousemove change', function () {
        var query = $("#depe_eleanio_actual").val();
