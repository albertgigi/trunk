    ...
    $('#container').highcharts({
        ...
        plotOptions: {
          ...
          style: {
            ...
            data: [
            <?php
            $sql = "SELECT `v2gmcantidad_alumnos` AS CALWTR FROM gmpdcfactorgeiallv2";
          ...
          style: {
            ...
            data: [
            <?php
            $sql = "SELECT `v2gmrawm3wtrxgei` AS RWTRGEI FROM gmpdcfactorgeiallv2";
          ...
          style: {
            ...
            data: [
            <?php
            $sql = "SELECT `v2gmrawm3wtr` AS RWTR FROM gmpdcfactorgeiallv2";
  ...
  <table class="table table-bordered table-hover">
    ...
    <?php if($loadgei_a): ?>
      ...
      <tr>
        ...
        <td><?php echo $item->v2gmm3wtrcapitayear; ?> m3</td>
        <td><?php echo $item->v2gmwtrkgcapitayear; ?> kg</td>
