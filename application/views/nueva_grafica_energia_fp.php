			...
			var series = [
               {
                  dataLabels: { //SIRVE PARA MOSTRAR Y DAR FORMATO A LOS DATOS FLOTANTES DE LAS COLUMNAS DE LA GRÁFICA 
                     ...
                     color: '#000000',
                     align: 'center',
                     format: '{point.y:,.2f}', // SIRVE PARA MODIFICAR EL FORMATO DEL NUMERO A MOSTRAR https://www.highcharts.com/docs/chart-concepts/labels-and-string-formatting
...
<table id="" class="table table-condensed  table-hover">
		<thead>
			<tr>
				...
				<th class="text-center">Factor de Potencia</th>
			</tr>
		</thead>
		...
		<?php if($recibos): ?>
			...
			<tr>
				...
				<td class="text-center <?php if($item->factor < 90 && $item->factor > 0){ echo 'fp_deficiente';}?>"><?php echo $item->factor; ?></td>
			</tr>
			<?php endforeach; ?>
		<?php else: ?>
			<tr>
