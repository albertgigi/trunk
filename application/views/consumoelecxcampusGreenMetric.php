...
<div class="buscador">
	...
	<select
		...
		>
			<option value="">----</option>
		<?php foreach($catecexcgm as $item): ?>
...
<div>
		<h3>
	<?php if($resecexcgm): ?>
		<?php foreach($resecexcgm as $item): ?>
			<tr>
	...
	<div id = "sliders">
      ...
      <script language = "JavaScript">
      	$(document).ready(function() {
            ...
            var title = {
               text: '<?php echo $item->campus_gmtfinal?>'
            };
...
<table id="mugres" class="table table-condensed table-bordered table-hover">
		...
		<?php if($resecexcgm): ?>
			...
			<tr class="active">
				<td><b>Total</b></td>
				<td class="text-right"><b><?php echo number_format($Eneroelecxcampustot);?></b></td>
				<td class="text-right"><b><?php echo number_format($Febreroelecxcampustot);?></b></td>
				<td class="text-right"><b><?php echo number_format($Marzoelecxcampustot);?></b></td>
				<td class="text-right"><b><?php echo number_format($Abrilelecxcampustot);?></b></td>
				<td class="text-right"><b><?php echo number_format($Mayoelecxcampustot);?></b></td>
				<td class="text-right"><b><?php echo number_format($Junioelecxcampustot);?></b></td>
				<td class="text-right"><b><?php echo number_format($Julioelecxcampustot);?></b></td>
				<td class="text-right"><b><?php echo number_format($Agostoelecxcampustot);?></b></td>
				<td class="text-right"><b><?php echo number_format($Septiembreelecxcampustot);?></b></td>
				<td class="text-right"><b><?php echo number_format($Octubreelecxcampustot);?></b></td>
				<td class="text-right"><b><?php echo number_format($Noviembreelecxcampustot);?></b></td>
				<td class="text-right"><b><?php echo number_format($Diciembreelecxcampustot);?></b></td>
			</tr>
		<?php else: ?>
			<tr>
				<td colspan=10>Favor de seleccionar el campus a consultar.</td>
