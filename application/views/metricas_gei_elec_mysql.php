...
mysql_select_db("sdspanel1", $con); 
 ...
 $sql = "SELECT theyear, FORMAT((rawkwxgei/1000000), 2) AS rwkwgzen, FORMAT((rawkw/1000000), 2) AS rwkwzen, FORMAT((cantidad_alumnos/1000), 1) AS caluzen FROM pdc_factor_gei_all"; 
 //Se remplazo la tabla de "pdc_facotr_gei" por "pdc_factor_gei_all" debido a motivos de actualización.
...
$(function () {
    $('#container').highcharts({
        ...
        series: [{
            ...
            color: '#8a8a8a', //Se define el color
            data: [
            <?php echo join($data1, ',') ?>
            ],
            stack: 0
...
<div class="table-responsive">
  <table class="table table-bordered table-hover">
    <thead>
      <tr>
        <th rowspan=2>Año</th>
        <th rowspan=2>kWh Per Cápita por Año</th>
