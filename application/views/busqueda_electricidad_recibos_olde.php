	...
	<table class="table table-bordered table-hover">
		...
		<?php if($recibos): ?>
			...
			<tr>
				...
				<!--<td class="text-right">?php echo $item->consumo; ?> Kwh</td>ORIGINAL-->
				<td class="text-right"><?php echo number_format($item->consumo); ?> Kwh</td>
				...
				<td>
					<?php echo anchor('consumo_electricidad/recibo/'.$item->id, '<span class="icon-eye-open"></span> Ver', 'class="view" data-remodal-target="modal_ver"'); ?><br>
					<?php echo anchor('consumo_electricidad/actualizar/'.$item->id, '<span class="icon-edit"></span> Actualizar'); ?><br>
					<?php echo anchor('consumo_electricidad/borrar/'.$item->id, '<span class="icon-trash"></span> Borrar', 'class="delete"'); ?>
				</td>
			</tr>
			<?php endforeach; ?>
			<tr class="active">
				...
				<td></td>
				<td></td>
				<!--<td class="text-right"><b>?php echo $total_kwh;?> Kwh</b></td>ORIGINALESS-->
				<td class="text-right"><b><?php echo number_format($total_kwh);?> Kwh</b></td>
