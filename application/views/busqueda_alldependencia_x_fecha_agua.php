<?php  
 ...
 $query = "SELECT * FROM pdc_all_dep_agua ORDER BY dependencia ASC";
 $querySumaCosto = "SELECT sum(costo) as CostoTotal, sum(consumo) as ConsumoTotal FROM pdc_all_dep_agua";   
      ...
      $(document).ready(function(){  
           ...
           $('#filter').click(function(){  
                ...
                {  
                     $.ajax({  
						  method:"POST",
                          url:'http://www.paneldecontrol.sds.uanl.mx/application/views/all_fecha_agua.php',
                          crossDomain: true,
