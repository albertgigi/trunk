    ...
    $('#container').highcharts({
        ...
        plotOptions: {
          ...
          style: {
            ...
            data: [
            <?php
            $sql = "SELECT `gmcantidad_alumnos5yrs` AS CALGAS FROM 5yrs_gmpdc_factor_gei_all";
          ...
          style: {
            ...
            data: [
            <?php
            $sql = "SELECT `gmrawm3gas5yrs` AS RGAS FROM 5yrs_gmpdc_factor_gei_all";
          ...
          style: {
            ...
            data: [
            <?php
            $sql = "SELECT `gmrawm3gasxgei5yrs` AS RGASGEI FROM 5yrs_gmpdc_factor_gei_all";
  ...
  <table class="table table-bordered table-hover">
    ...
    <?php if($loadgei_g): ?>
      ...
      <tr>
        ...
        <td><?php echo $item->gmm3gascapitayear5yrs; ?> m3</td>
        <td><?php echo $item->gmgaskgcapitayear5yrs; ?> kg</td>
