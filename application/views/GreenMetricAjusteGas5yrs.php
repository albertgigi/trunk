   ...
   <div id = "sliders">
      ...
      <script language = "JavaScript">
         $(document).ready(function() {
            ...
            var title = {
               text: 'GAS <?php echo $item->campus_gmtfinal?>'
            };
...
<table id="mugres" class="table table-condensed table-bordered table-hover">
      ...
      <?php if($resecexcgm5yrs): ?>
         ...
         <tr class="active">
            <td><b>Total</b></td>
            <td class="text-right"><b><?php echo number_format($Enerogaasxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Febrerogaasxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Marzogaasxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Abrilgaasxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Mayogaasxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Juniogaasxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Juliogaasxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Agostogaasxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Septiembregaasxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Octubregaasxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Noviembregaasxcampustot5yrs);?></b></td>
            <td class="text-right"><b><?php echo number_format($Diciembregaasxcampustot5yrs);?></b></td>
         </tr>
      <?php else: ?>
         <tr>
            <td colspan=10>Favor de seleccionar el campus a consultar.</td>
