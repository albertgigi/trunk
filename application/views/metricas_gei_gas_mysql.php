<!--
ESTA GRÁFICA HACE REFERENCIA AL CONSUMO ANUAL DE GAS, ASÍ COMO LA CANTIDAD DE GAS EFECTO INVERNADERO QUE PRODUCE.
-->
<?php
$con = mysql_connect('localhost', 'sdspan3', 'RTRIUHG54637') or die('Error connecting to server');
mysql_select_db("sdspanel1", $con); 

    $sql = "SELECT theyear, FORMAT((rawm3gasxgei / 100000), 3) AS rwm3ggas, FORMAT((rawm3gas / 10000), 3) AS rawraw, FORMAT((cantidad_alumnos / 1000), 2) AS calgas FROM pdc_factor_gei_all";
...
$(function () {
    $('#container').highcharts({
        ...
        series: [{ //Se declaran/establecen las cantidades previamente definidas en el query de sql.
            ...
            name: 'Consumo Anual de Gas(m3) - Millones',
  ...
  <table class="table table-bordered table-hover">
    ...
    <?php if($loadgei_g): ?>
      ...
      <tr>
        ...
        <td><?php echo $item->m3gascapitayear; ?></td>
        <td><?php echo $item->gaskgcapitayear; ?></td>
