...
<table id="mugres" class="table table-condensed table-bordered table-hover">
      ...
      <?php if($resecexcgmv2): ?>
         ...
         <tr class="active">
            <td><b>Total</b></td>
            <td class="text-right"><b><?php echo number_format($Enerogaasxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Febrerogaasxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Marzogaasxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Abrilgaasxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Mayogaasxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Juniogaasxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Juliogaasxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Agostogaasxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Septiembregaasxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Octubregaasxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Noviembregaasxcampustotv2);?></b></td>
            <td class="text-right"><b><?php echo number_format($Diciembregaasxcampustotv2);?></b></td>
         </tr>
      <?php else: ?>
         <tr>
            <td colspan=10>Favor de seleccionar el campus a consultar.</td>
