...
<div class="buscador">
   ...
   <select id="cta_eleanio_actual" name="cta_eleanio_actual" class="form-control">
   <option value="">----</option>
      <?php foreach($catdepescta as $item): ?>
         <option value="<?php echo $item->cta_eleanio_actual; ?>"
         <?php if($cta_eleanio_actual) echo ($item->cta_eleanio_actual==$cta_eleanio_actual)? 'selected' : ''; ?>>
         <?php echo $item->cta_eleanio_actual." - ".$item->depe_eleanio_actual; ?></option>
      <?php endforeach; ?>
      </select>
</div>
<!--
<select id="messeleccionar" name="messeleccionar">
    <option>Mes a consultar</option>
...
var f=new Date();
document.write("Recibo del mes de: " + meses[f.getMonth() -1]);
</script></label></center>
</div>
</div>
</body>
...
<div>
NIS:
 <?php if($resultdependenciacta): ?>
      <?php foreach($resultdependenciacta as $item): ?>
         <?php print $item->cta_eleanio_actual; break;?>
         </tr>
         <?php endforeach; ?>
         <?php endif; ?>
         </h5>
   ...
   <?php if($resultdependenciacta): ?>
      <?php foreach($resultdependenciacta as $item): ?>
            ...
            <?php print number_format($item->consumo_actual, 0, "", ",");
            break; ?>
...
<section class="content">    
    ...
    <!--div style="margin:-1vh; width:10vh;"-->
        <table id="tablaCategorias" class="table table-striped table-bordered wrap" style="width:100%;">
            <thead class="bg-info">
                <tr>
...
<script type="text/javascript">
  function generatePDF() {
        ...
        var opt = {
            margin:       1,
            filename:     'comparativo_electricidad_<?php echo $item->depe_eleanio_actual?>_<?php
...
<script>
   ...
   $(document).ready(function () {
    ...
    $(".form-control").on('mousemove change', function () {
        var query = $("#cta_eleanio_actual").val();
