                    ...
                    <ul id="planmetric">
                        <li>
                            <b>Recibos</b>
                                <ul>
                                    <li><?php
                                if($_SESSION['sess']['level'] == 1){ echo anchor("consumo_electricidad/capturar/", "Capturar un recibo"); } ?>
                                    </li>
                        ...
                        <h7><?php if($_SESSION['sess']['level'] == 1){ echo anchor("", "Servicios"); }?></h7>
                                <ul>
                                <li><?php
                                if($_SESSION['sess']['level'] == 1){
                                    echo anchor("consumo_electricidad/servicio_registrar/", "Registrar nuevo servicio"); 
                                }
                                ?>
                                </li>
                                <li><?php
                                if($_SESSION['sess']['level'] == 1){ echo anchor("consumo_electricidad/servicio_catalogo/", "Catálogo de servicios"); }?></li>
                                </ul>
                        </li>
                    </ul>
                    <ul id="planmetric">
            ...
            <div class="center">
                 <h2>Directorio</h2><br>
                    ...
                    <div class="col-sm-6">
                        ...
                        <h4>Director de Tecnologías de Información</h4><br>
